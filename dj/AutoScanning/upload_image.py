...
if __name__ == '__main__':
    wf_list = ['13443', '10395', '13442']
    file_list = FileObjectManager(FileObject("G:\dzt\资料\交警\载货汽车限行")).scan_with_depth(10).all_file_objects()
    b = QZ(file_list, r"D:\WorkDocument\ITS\backup", r'192.168.31.54:8000', "G:\dzt\资料\交警\载货汽车限行",
