...
# GetCarId.py 中离线操作 进入LicensePlateCatcher -> initialization() -> 修改 settings.py中 _DEFAULT_FOLDER_
#     file_folder = os.getcwd()
#     logs_file_folder = os.path.join(file_folder, "_internal")
#     _DEFAULT_FOLDER_ = os.path.join(logs_file_folder, "models")

# dateAndAddress.py 中离线操作
# file_folder = os.getcwd()
# logs_file_folder = os.path.join(file_folder, "_internal")
...
if __name__ == '__main__':
    ...
    font_file = os.path.join(font_folder, "tv256.ico")
    root.iconbitmap(font_file)  # 设置窗口图标
